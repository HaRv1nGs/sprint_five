...
func (t Training) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	mes := InfoMessage{}
	mes.TrainingType = t.TrainingType
	mes.Duration = t.Duration
	mes.Distance = t.distance()
	mes.Speed = t.meanSpeed()
	mes.Calories = t.Calories()
...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	mes := InfoMessage{}
	mes.TrainingType = r.TrainingType
	mes.Duration = r.Duration
	mes.Distance = r.distance()
	mes.Speed = r.meanSpeed()
	mes.Calories = r.Calories()
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	mes := InfoMessage{}
	mes.TrainingType = w.TrainingType
	mes.Duration = w.Duration
	mes.Distance = w.distance()
	mes.Speed = w.meanSpeed()
	mes.Calories = w.Calories()
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	time := s.Duration.Hours()
	if time == 0 {
		return 0
	}
	speed := float64(s.LengthPool) * float64(s.CountPool) / MInKm / time
	return speed
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	mes := InfoMessage{}
	mes.TrainingType = s.TrainingType
	mes.Duration = s.Duration
	mes.Distance = s.distance()
	mes.Speed = s.meanSpeed()
	mes.Calories = s.Calories()
